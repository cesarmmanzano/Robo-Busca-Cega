...
def RenderTexts(window):
    ...
    aStarText = myfont.render(Commons.A_ALGORITHM, True, Commons.BLACK)
    bSearchText = myfont.render(Commons.BUTTON_2_TEXT, True, Commons.BLACK)
    window.blit(aStarText, (140, 165))
    window.blit(bSearchText, (140, 265))
    names = nameFont.render(Commons.NAMES_TITLE, True, Commons.WHITE)
    window.blit(names, (5, 5))
    instructions = nameFont.render(Commons.INSTRUCTIONS_TITLE, True, Commons.WHITE)
    window.blit(instructions, (5, 35))
    instructions1 = nameFont.render(Commons.INSTRUCTIONS_TITLE1_MENU, True, Commons.WHITE)
    window.blit(instructions1, (5, 55))
    instructions2 = nameFont.render(Commons.INSTRUCTIONS_TITLE2_MENU, True, Commons.WHITE)
    window.blit(instructions2, (5, 75))
    instructions3 = nameFont.render(Commons.INSTRUCTIONS_TITLE3_MENU, True, Commons.WHITE)
